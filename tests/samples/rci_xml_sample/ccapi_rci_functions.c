...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_action_start(info);
}
...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_group_set_ccapi_on_off(info, value);
}
...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_group_get_ccapi_bool(info, value);
}
...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_group_set_ccapi_bool(info, value);
}
...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_group_get_integer(info, value);
}
...
{
    printf("    Called '%s'\n", __FUNCTION__);
    return ccapi_xml_rci_handle_group_set_integer(info, value);
}
