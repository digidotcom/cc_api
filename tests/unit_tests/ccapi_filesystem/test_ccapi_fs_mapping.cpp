...
TEST(test_ccapi_fs_mapping, testMapDirNoMemory4DirEntry)
{
    ...
    char const * const actual_path = "/home/user/my_directory";
...
TEST(test_ccapi_fs_mapping, testMapDirNoMemory4ActualPath)
{
    ...
    /* Test Setup */
    {
        ...
        void * malloc_for_actual_path = NULL;
...
TEST(test_ccapi_fs_mapping, testMapDirNoMemory4VirtualPath)
{
    ...
    {
        void * malloc_for_dir_list_entry = malloc(sizeof (ccapi_fs_virtual_dir_t));
        void * malloc_for_actual_path = malloc(strlen(actual_path) + 1);
...
TEST(test_ccapi_fs_mapping, testMapDirOK)
{
    ...
    STRCMP_EQUAL(actual_path, ccapi_data_single_instance->service.file_system.virtual_dir_list->actual_path);
}
...
TEST(test_ccapi_fs_mapping, testMapTwoDirs)
{
    ...
    char const * const actual_path_1 = "/home/user/my_directory";
    char const * const virtual_path_1 = "my_virtual_dir";
    char const * const actual_path_2 = "/home/other_user/other_my_directory";
    char const * const virtual_path_2 = "other_virtual_dir";
    /* Test Setup */
    {
        void * malloc_for_dir_list_entry_1 = malloc(sizeof (ccapi_fs_virtual_dir_t));
        void * malloc_for_actual_path_1 = malloc(strlen(actual_path_1) + 1);
        ...
        void * malloc_for_actual_path_2 = malloc(strlen(actual_path_2) + 1);
    ...
    STRCMP_EQUAL(actual_path_1, ccapi_data_single_instance->service.file_system.virtual_dir_list->actual_path);
    ...
    STRCMP_EQUAL(actual_path_2, ccapi_data_single_instance->service.file_system.virtual_dir_list->next->actual_path);
}
