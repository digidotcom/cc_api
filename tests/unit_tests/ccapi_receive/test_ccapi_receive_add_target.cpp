...
TEST(test_ccapi_receive_add_target_no_CCAPI, testCcapiNotStarted)
{
    ...
    error = ccapi_receive_add_target(TEST_TARGET, specific_receive_data_cb, specific_receive_status_cb);
...
TEST(test_ccapi_receive_add_target, testTargetNull)
{
    ...
    error = ccapi_receive_add_target(NULL, specific_receive_data_cb, specific_receive_status_cb);
...
TEST(test_ccapi_receive_add_target, testTargetEmpty)
{
    ...
    error = ccapi_receive_add_target("", specific_receive_data_cb, specific_receive_status_cb);
    CHECK_EQUAL(CCAPI_RECEIVE_ERROR_NONE, error);
...
TEST(test_ccapi_receive_add_target, testTargetAlreadyAdded)
{
    ...
    error = ccapi_receive_add_target("other_target", specific_receive_data_cb, specific_receive_status_cb);
    CHECK_EQUAL(CCAPI_RECEIVE_ERROR_NONE, error);
