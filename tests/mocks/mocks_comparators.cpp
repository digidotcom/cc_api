...
MockFunctionComparator connector_sm_send_ping_request_t_comparator(connector_request_data_service_send_t_IsEqual, connector_request_data_service_send_t_ValueToString);
