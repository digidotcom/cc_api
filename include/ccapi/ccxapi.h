...
ccapi_receive_error_t ccxapi_receive_add_target(ccapi_handle_t const ccapi_handle, char const * const target, ccapi_receive_data_cb_t data_cb, ccapi_receive_status_cb_t status_cb);
